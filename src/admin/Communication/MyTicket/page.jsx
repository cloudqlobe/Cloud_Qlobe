...
import { RequestsTable, ViewPage } from "./table";
import AdminAuthContext from "../../../context/admin/AdminAuthContext";
import axiosInstance from "../../../utils/axiosinstance";

const MemberCommiunctionMyTicket = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        const [response, didresponse] = await Promise.all([
        ...
        setAllRequests([...EnquiryData, ...DIDData]);
      } catch (error) {
...
export default MemberCommiunctionMyTicket;