...
const Homecontent1 = () => {
  return (
    <div className="min-h-screen w-full bg-white px-4 sm:px-6 md:px-10 lg:px-12 py-12 sm:py-16 overflow-hidden mt-[-40px]">
      ...
      <div
        aria-hidden="true"
        className="text-2xl sm:text-3xl md:text-[34px] lg:text-[40px] font-normal font-[Roboto,Arial,sans-serif] text-center text-[#3c4043] mb-12 md:mb-20 mt-6 leading-snug px-2"
      >
      ...
      {/* CC Routes Section */}
      <section className="grid grid-cols-1 md:grid-cols-2 items-center gap-8 md:gap-10 mb-16 max-w-7xl mx-auto">
        <div className="flex justify-center items-center w-full">
          <img
            src={Homeimage2}
            alt="CC Routes"
            className="w-[90%] sm:w-[80%] md:w-[580px] h-auto object-cover rounded-lg"
          />
        </div>
        <div className="flex flex-col justify-center w-full md:max-w-[850px] px-3">
          <h2 className="text-xl sm:text-[22px] md:text-[28px] font-normal font-[Roboto,Arial,sans-serif] text-[#202124] mb-4 text-center md:text-left">
      ...
      <section className="grid grid-cols-1 md:grid-cols-2 items-center gap-8 md:gap-10 mb-16 max-w-7xl mx-auto">
        <div className="order-2 md:order-1 flex flex-col justify-center w-full md:max-w-[850px] px-3">
          <h2 className="text-xl sm:text-[22px] md:text-[28px] font-normal font-[Roboto,Arial,sans-serif] text-[#202124] mb-4 text-center md:text-left">
        ...
        <div className="order-1 md:order-2 flex justify-center items-center w-full">
          <img
            ...
            className="w-[90%] sm:w-[80%] md:w-[680px] h-auto object-cover rounded-lg"
          />
        </div>
      </section>

      {/* DID Solutions Section */}
      <section className="grid grid-cols-1 md:grid-cols-2 items-center gap-8 md:gap-10 max-w-7xl mx-auto">
        <div className="flex justify-center items-center w-full">
          <img
            src={Homeimage3}
            alt="DID Solutions"
            className="w-[90%] sm:w-[80%] md:w-[520px] h-auto object-cover rounded-lg"
          />
        </div>
        <div className="flex flex-col justify-center w-full md:max-w-[850px] px-3">
          <h2 className="text-xl sm:text-[22px] md:text-[28px] font-normal font-[Roboto,Arial,sans-serif] text-[#202124] mb-4 text-center md:text-left">
