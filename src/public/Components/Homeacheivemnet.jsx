...
const stats = [
  ...
  },
  {
    ...
    value: '250+',
    label: 'Innterconnections',
    description: 'Reliable, high-volume of global innterconnections ',
  },
  {
    id: 3,
  ...
  return (
    <section className="bg-[#0a2463] text-white py-20 px-6">
      <div className="max-w-7xl mx-auto">
        ...
        {/* Country Flags Set 1 */}
        <h3 className="text-2xl font-default text-white text-center mb-8"> Our Major destinations route </h3>
